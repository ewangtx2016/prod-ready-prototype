...
const sample: RoleItem[] = [
  { id: "PR1", name: "我是角色", roleType: "platform", dataScope: "all", enabled: true, createdAt: "2026-05-18 10:23:46", permIds: [] },
  { id: "PR2", name: "角色000", roleType: "org", dataScope: "specified_org", enabled: true, createdAt: "2026-05-17 17:31:29", permIds: [] },
  { id: "PR3", name: "acdd", roleType: "platform", dataScope: "specified_org", enabled: true, createdAt: "2026-05-15 22:03:45", permIds: [] },
  { id: "PR4", name: "我是新创建角色0515", roleType: "platform", dataScope: "all", enabled: true, createdAt: "2026-05-15 19:22:50", permIds: [] },
  { id: "PR5", name: "sdg", roleType: "org", dataScope: "specified_org", enabled: true, createdAt: "2026-05-15 19:00:25", permIds: [] },
];
...
function Page() {
  ...
  const hasFilter = !!keyword || typeFilter !== "all" || statusFilter !== "all";
  const reset = () => {
    setKeyword("");
    setTypeFilter("all");
    setStatusFilter("all");
