...
import {
  ...
  Settings, ShieldCheck, Users, History, ChevronDown, UserCircle2,
} from "lucide-react";
...
const GROUPS: Group[] = [
  ...
  { key: "customer", label: "用户管理", icon: UserCircle2, children: [
    { to: "/customer", label: "用户列表", icon: UserCircle2, key: "customer" },
  ] },
